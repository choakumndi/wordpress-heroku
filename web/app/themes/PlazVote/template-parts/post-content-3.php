...
if (!theme_the_post()) return;
 $post0 = $post;
 ?>
<?php $skip_min_height = false; ?><section class="u-clearfix u-section-3" id="sec-ebc8">
  <div class="u-clearfix u-sheet u-sheet-1">
    ...
    <div class="u-metadata u-metadata-1">
      ...
      <?php if ($post0 !== null) { ?><?php if (comments_open()): ?><span class="u-meta-comments u-meta-icon"><a class="u-textlink" href="<?php echo get_comments_link(); ?>">
                                        <?php _e(sprintf(__('Comments (%d)', 'plazvote'), (int)get_comments_number())); ?>
    ...
    <?php if ($post0 !== null) { ?><a href="<?php the_permalink(); ?>" class="u-blog-control u-link u-link-1"><?php _e(sprintf(__('Read more', 'plazvote'))); ?></a><?php } ?>
  </div>
