...
class NpAdminActions {
    ...
    public static function getProductsPost($item) {
        ...
        if (function_exists('wc_get_product')) {
            ...
            $desc = plugin_trim_long_str(self::getTheExcerpt($item->ID), 150);
        ...
        // all post data
        $data = array(
            'product-title' => isset($title) ? $title : '',
            'product-desc' => isset($desc) ? $desc : '',
            'product-image' => isset($image_url) ? $image_url : '',
            'product-price' => isset($price) ? get_woocommerce_currency_symbol() . $price : '',
            'product-old-price' => isset($price_old) ? $price_old : '',
